...
# Edit these values
origin = [-500,-500,-500] #origin of area to map in DFN domain coordinates (0,0,0 is center of DFN) #front botom left hand corner
nx = 50
ny = 50
nz = 50
d = 20.  #grid cell size, discretization
k_background = 1.e-18 #permeability for cells not intersected by fracture(s)
bulk_por = 0.005  #porosity for cells not intersected by fracture(s)
tortuosity_factor = 0.001 #correction factor to achieve the effective diffusion coefficient

#this is origin of mapping in cpm domain
